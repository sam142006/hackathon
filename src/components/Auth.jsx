...
import { FaUser, FaEnvelope, FaLock, FaBriefcase, FaGraduationCap, FaArrowLeft } from 'react-icons/fa';
            ...
            <form onSubmit={handleOtpSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 outline-none transition-all text-center text-2xl tracking-widest"
                  required
                  disabled={loading}
                  maxLength="6"
                  autoFocus
              ...
              <button
                ...
                className="w-full py-3 px-4 bg-gradient-to-r from-teal-500 to-green-500 text-white rounded-lg font-semibold hover:from-teal-600 hover:to-green-600 transition-all duration-300 transform hover:scale-105 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
              >
